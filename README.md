...
[![Latest Stable Version](https://poser.pugx.org/evk/bxmigrate/version)](https://packagist.org/packages/evk/bxmigrate)
[![License](https://poser.pugx.org/evk/bxmigrate/license)](https://packagist.org/packages/evk/bxmigrate)
[![Latest Unstable Version](https://poser.pugx.org/evk/bxmigrate/v/unstable)](https://packagist.org/packages/evk/bxmigrate)
...
\Evk\BxMigrate\Cli\Factory::registerCommands($application, CLI_MIGRATIONS_PATH);
...
3. реализовать методы up и down для данной миграции, например:
     ...
     */
    class migrate_/*TIMESTAMP_СОЗДАНИЯ_МИГРАЦИИ*/_new_migration extends \Evk\BxMigrate\migrate\Coded
    {
        public function up()
        {
